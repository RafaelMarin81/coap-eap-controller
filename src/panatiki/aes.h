/*
 ...
 This is an AES implementation that uses only 8-bit uint8_t operations on the
 cipher state.
 */
...
/*  Warning: The key length for 256 bit keys overflows a uint8_t
    (see comment below)
*/
...
/*  The following calls are for a precomputed key schedule
    ...
    be entered as a length in uint8_ts (valid inputs are hence
